...
- **Phase 12 (serving).** Caches + latency budgeting. *Finding:* **generation is 99.99% of the
  p50 latency budget** (1287 of 1287.2 ms); retrieval is 0.006%. **Every Phase 4 to 7 retrieval
...
*(Corpus caveat, measured not guessed: at n=20 the bootstrap CI half-width is ±0.10 to 0.20, so
