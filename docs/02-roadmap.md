...
## Phase 0: Harness, datasets, metrics, naive baseline (Weeks 1 to 4). FOUNDATION
...
## Phase 1: Ingestion & parsing (Weeks 5 to 7)
...
## Phase 2: Chunking (Weeks 8 to 11)
...
## Phase 3: Embeddings ➕ (Weeks 12 to 15)
...
## Phase 4: Indexing & vector stores (Weeks 16 to 19)
...
## Phase 5: Retrieval (Weeks 20 to 23)
...
## Phase 6: Query understanding ➕ (Weeks 24 to 28)
...
## Phase 7: Reranking (Weeks 29 to 32)
...
## Phase 8: Context assembly (Weeks 33 to 36)
...
## Phase 9: Advanced retrieval flows (Weeks 37 to 43)
...
## Phase 10: Generation (Weeks 44 to 47)
...
## Phase 11: Evaluation deep-dive (Weeks 48 to 53)
...
## Phase 12: Serving & performance ➕ (Weeks 54 to 58)
...
## Phase 13: Observability & ops ➕ (Weeks 59 to 63)
...
## Phase 14: Security & governance ➕ (Weeks 64 to 68)
...
## Phase 15: Scaling & maintenance ➕ (Weeks 69 to 74)
...
## Phase 16: Capstone integration & leaderboard (Weeks 75 to 80). HEADLINE
