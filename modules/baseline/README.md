...
2. **`extractive_mock` is a floor, not a substitute**, 0.232 to 0.328 token-F1 vs the real model's
   0.355 to 0.423. It's honest about what it is: a sentence-picker with no attention, which is why
